...
- [x] Surface negpro clipping risk warnings to users when contrast stretch clipping may be too aggressive for narrow density range images
- [x] Update commander from v2 to v12 (enables configureHelp, addHelpText, and other modern features)
- [x] Group and reorder CLI flags in --help output (Input/Output, Processing Mode, Tuning, Deprecated, Utility)
- [x] Add --examples screen with usage examples and explanations
- [x] Figure out if we can identify when the default CS/Clip params are likely to produce poor results and show warnings
